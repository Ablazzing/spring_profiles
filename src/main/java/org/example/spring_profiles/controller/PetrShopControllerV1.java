...
@RestController
@RequestMapping("/petr/v1")
@Profile("petr")
@Slf4j
public class PetrShopControllerV1 implements ShopController {
    ShopService shopService;
    @Value("${shop.thx}")
    private String thx;

    @Autowired
    public PetrShopControllerV1(@Qualifier("petrShopService") ShopService shopService) {
